...
var callBind = bind$8 && bind$8.bind(call$c);

var functionUncurryThis = bind$8 ? function (fn) {
  return fn && callBind(call$c, fn);
} : function (fn) {
  return fn && function () {
...
var functionApply = typeof Reflect == 'object' && Reflect.apply || (bind$7 ? call$b.bind(apply$4) : function () {
...
var getBuiltIn$a = function (namespace, method) {
  return arguments.length < 2 ? aFunction(path$8[namespace]) || aFunction(global$E[namespace])
    : path$8[namespace] && path$8[namespace][method] || global$E[namespace] && global$E[namespace][method];
};
...
var isSymbol$2 = USE_SYMBOL_AS_UID$1 ? function (it) {
  ...
  return isCallable$e($Symbol) && isPrototypeOf$9($Symbol.prototype, Object$5(it));
};
...
var setGlobal$1 = function (key, value) {
  try {
    defineProperty$6(global$y, key, { value: value, configurable: true, writable: true });
  } catch (error) {
    global$y[key] = value;
  } return value;
};
...
var _export = function (options, source) {
  ...
  var target = GLOBAL ? path$7 : path$7[TARGET] || createNonEnumerableProperty$6(path$7, TARGET, {})[TARGET];
  ...
  for (key in source) {
    ...
    else if (PROTO && isCallable$a(sourceProperty)) resultProperty = uncurryThis$f(sourceProperty);
    // default case
    ...
    if (PROTO) {
      ...
      if (!hasOwn$8(path$7, VIRTUAL_PROTOTYPE)) {
        createNonEnumerableProperty$6(path$7, VIRTUAL_PROTOTYPE, {});
      }
      // export virtual prototype methods
      createNonEnumerableProperty$6(path$7[VIRTUAL_PROTOTYPE], key, sourceProperty);
...
var findIndex$4 = entryVirtual$6('Array').findIndex;

var isPrototypeOf$8 = objectIsPrototypeOf;
var method$4 = findIndex$4;

var ArrayPrototype$6 = Array.prototype;

var findIndex$3 = function (it) {
  var own = it.findIndex;
  return it === ArrayPrototype$6 || (isPrototypeOf$8(ArrayPrototype$6, it) && own === ArrayPrototype$6.findIndex) ? method$4 : own;
};

var parent$n = findIndex$3;

var findIndex$2 = parent$n;

var parent$m = findIndex$2;

var findIndex$1 = parent$m;
...
var concat$5 = uncurryThis$9([].concat);
...
if (!isCallable$3(IteratorPrototype$1[ITERATOR$3])) {
...
var speciesConstructor$2 = function (O, defaultConstructor) {
  ...
  var S;
  return C === undefined || (S = anObject$1(C)[SPECIES$2]) == undefined ? defaultConstructor : aConstructor(S);
};
...
if (!set || !clear) {
  set = function setImmediate(fn) {
    ...
    queue[++counter] = function () {
      apply$2(isCallable$2(fn) ? fn : Function$1(fn), undefined, args);
    };
    defer(counter);
    return counter;
  };
...
$$f({ global: true, wrap: true, forced: FORCED$3 }, {
...
// statics
$$f({ target: PROMISE, stat: true, forced: FORCED$3 }, {
...
// `Object.defineProperty` method
// https://tc39.es/ecma262/#sec-object.defineproperty
$$a({ target: 'Object', stat: true, forced: !DESCRIPTORS, sham: !DESCRIPTORS }, {
...
var parent$j = defineProperty$4.exports;

var defineProperty$2 = parent$j;

var parent$i = defineProperty$2;

var defineProperty$1 = parent$i;
...
// https://tc39.es/ecma262/#sec-array.prototype.foreach
// eslint-disable-next-line es/no-array-prototype-foreach -- safe
$$9({ target: 'Array', proto: true, forced: [].forEach != forEach$5 }, {
  forEach: forEach$5
});
...
var parent$d = concat$3;

var concat$2 = parent$d;
...
var parent$b = includes$3;

var includes$2 = parent$b;
...
var parent$5 = _parseInt$3;

var _parseInt$2 = parent$5;
...
var Date = global$2.Date;
var getTime = uncurryThis$1(Date.prototype.getTime);

// `Date.now` method
// https://tc39.es/ecma262/#sec-date.now
$$1({ target: 'Date', stat: true }, {
  now: function now() {
...
var parent$1 = stringify$3;

var stringify$2 = parent$1;
  ...
  _createClass(TinyPng, [{
    ...
    value: function () {
      var _compress = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        ...
        var asyncAll, _context3, _context4, __p, i, target;
        ...
        return regenerator.wrap(function _callee$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 13:
                Tlog.log(concat(_context4 = "\u5904\u7406\u5B8C\u6BD5: \u6210\u529F: ".concat(this.successCount, "\u5F20, \u6210\u529F\u7387")).call(_context4, this.successCount / this.config.files.length * 100, "%"));
    ...
    value: function fileFilter(folder) {
      ...
      // 读取文件夹
      forEach(_context6 = fs__default["default"].readdirSync(folder)).call(_context6, function (file) {
        var _context7;
        ...
        if (fileStat.size <= _this3.config.max && fileStat.size >= _this3.config.min && fileStat.isFile() && includes(_context7 = _this3.config.extension).call(_context7, path__default["default"].extname(file))) {
    ...
    value: function getAjaxOptions() {
      ...
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          _ref$path = _ref.path,
          path = _ref$path === void 0 ? '/backend/opt/store' : _ref$path,
          _ref$contentType = _ref.contentType,
          contentType = _ref$contentType === void 0 ? 'image/png' : _ref$contentType;
      ...
      return {
        ...
        headers: {
          ...
          'X-Forwarded-For': map(_context8 = fill(_context9 = Array(4)).call(_context9, 1)).call(_context8, function () {
    ...
    value: function fileUpload(imgPath) {
      ...
      return new promise(function (resolve, reject) {
        ...
        var process = function process() {
          var req = https__default["default"].request(_this4.getAjaxOptions(), /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(res) {
              var key, compressInfo, _context10, _context11;
                ...
                while (1) {
                  switch (_context12.prev = _context12.next) {
                    case 0:
                      ...
                      key = res.headers.location.split('/').pop();
                      _context12.next = 4;
                      return _this4.fileProcess(imgPath, key);

                    case 4:
                      compressInfo = _context12.sent;
                      _context12.t0 = resolve;
                      _context12.next = 8;
                      return _this4.fileUpdate(imgPath, compressInfo);
                    ...
                    case 12:
                      Tlog.log(concat(_context10 = "\u538B\u7F29\u5931\u8D25\uFF01\n \u5F53\u524D\u6587\u4EF6\uFF1A".concat(imgPath, " \n ")).call(_context10, obj.message));
                      reject(concat(_context11 = "\u538B\u7F29\u5931\u8D25\uFF01\n \u5F53\u524D\u6587\u4EF6\uFF1A".concat(imgPath, " \n ")).call(_context11, obj.message));
          ...
          var file = fs__default["default"].readFileSync(imgPath);
    ...
    key: "fileProcess",
    value: function fileProcess(imgPath, key) {
      var _this5 = this;
      ...
      return new promise(function (resolve, reject) {
        ...
        var process = function process() {
          var req = https__default["default"].request(_this5.getAjaxOptions({
            path: '/backend/opt/process',
            contentType: 'application/json'
          }), /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(res) {
              return regenerator.wrap(function _callee4$(_context16) {
                while (1) {
                  switch (_context16.prev = _context16.next) {
                    case 0:
                      res.on('data', /*#__PURE__*/function () {
                        var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(buf) {
                          var obj, _context14;

                          return regenerator.wrap(function _callee3$(_context15) {
                            while (1) {
                              switch (_context15.prev = _context15.next) {
                                case 0:
                                  ...
                                  if (obj.error) {
                                    Tlog.log(concat(_context14 = "\u538B\u7F29\u5931\u8D25\uFF01\n \u5F53\u524D\u6587\u4EF6\uFF1A".concat(imgPath, " \n ")).call(_context14, obj.message));
                                  } else {
          ...
          var body = {
            key: key,
            originalSize: fs__default["default"].statSync(imgPath).size,
            // mime type
            originalType: "image/".concat(path__default["default"].extname(imgPath).replace('.', ''))
          };
          req.write(stringify(body), 'binary');
          req.on('error', function (e) {
            if (retryCount < 3) {
              retryCount++;
              process();
    ...
    value: function fileUpdate(entryImgPath, obj) {
      ...
      return new promise(function (resolve, reject) {
        var options = new url.URL(obj.url);
        var retryCount = 0;
        var originalSize = fs__default["default"].statSync(entryImgPath).size;
        var ratio = obj.size / originalSize;
        ...
        var process = function process() {
            ...
            res.on('end', function () {
              fs__default["default"].writeFile(entryImgPath, body, 'binary', function (err) {
                if (err) {
                  ...
                  var message = concat(_context18 = concat(_context19 = concat(_context20 = "\u538B\u7F29\u6210\u529F : \u4F18\u5316\u6BD4\u4F8B: ".concat(((1 - ratio) * 100).toFixed(2), "% \uFF0C\u539F\u59CB\u5927\u5C0F: ")).call(_context20, (originalSize / 1024).toFixed(2), "KB \uFF0C\u538B\u7F29\u5927\u5C0F: ")).call(_context19, (obj.size / 1024).toFixed(2), "KB \uFF0C\u6587\u4EF6\uFF1A")).call(_context18, entryImgPath);
          ...
          req.on('error', function (e) {
            if (retryCount < 3) {
              ...
              reject(concat(_context21 = "\u4E0B\u8F7D\u5931\u8D25\uFF0C\u5F53\u524D\u6587\u4EF6".concat(entryImgPath, ", ")).call(_context21, e));
            }
          });
          req.end();
        };
...
function getEntryPath() {
  ...
  var i = findIndex(_context = process.argv).call(_context, function (i) {
    return i === "-p";
  });
