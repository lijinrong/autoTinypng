...
var functionApply = typeof Reflect == 'object' && Reflect.apply || (bind$7 ? call$b.bind(apply$2) : function () {
...
var parent$l = findIndex$3;

var findIndex$2 = parent$l;

var parent$k = findIndex$2;

var findIndex$1 = parent$k;
...
var concat$5 = uncurryThis$8([].concat);
...
var NEW_ITERATOR_PROTOTYPE = IteratorPrototype$1 == undefined || fails$7(function () {
  var test = {};
...
if (!set || !clear) {
  ...
  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
    ...
    isCallable$2(global$a.postMessage) &&
...
var NATIVE_REJECTION_EVENT = isCallable$1(global$6.PromiseRejectionEvent);
          ...
          var req = https__default["default"].request(_this4.getAjaxOptions(), function (res) {
            res.on("data", /*#__PURE__*/function () {
              var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(buf) {
                ...
                return regenerator.wrap(function _callee2$(_context11) {
                  while (1) {
            ...
            res.on("end", function () {
              fs__default["default"].writeFile(entryImgPath, body, "binary", function (err) {
                if (err) {
                  ...
                  var message = concat(_context13 = concat(_context14 = concat(_context15 = "\u538B\u7F29\u6210\u529F : \u4F18\u5316\u6BD4\u4F8B: ".concat(((1 - obj.output.ratio) * 100).toFixed(2), "% \uFF0C\u539F\u59CB\u5927\u5C0F: ")).call(_context15, (obj.input.size / 1024).toFixed(2), "KB \uFF0C\u538B\u7F29\u5927\u5C0F: ")).call(_context14, (obj.output.size / 1024).toFixed(2), "KB \uFF0C\u6587\u4EF6\uFF1A")).call(_context13, entryImgPath);
