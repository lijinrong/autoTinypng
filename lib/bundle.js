  ...
  _createClass(TinyPng, [{
    ...
    value: function compress() {
      ...
      if (this.config.files.length > 0) {
        ...
        promise.all(asyncAll).then(function () {
          var _context4;

          Tlog.log(concat(_context4 = "\u5904\u7406\u5B8C\u6BD5: \u6210\u529F: ".concat(_this2.successCount, "\u5F20, \u6210\u529F\u7387")).call(_context4, _this2.successCount / _this2.config.files.length));
      ...
      return new promise(function (resolve) {
        var req = https__default["default"].request(_this4.getAjaxOptions(), function (res) {
          res.on("data", /*#__PURE__*/function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(buf) {
              var obj, _context9;

              return regenerator.wrap(function _callee$(_context10) {
                while (1) {
                  switch (_context10.prev = _context10.next) {
                    case 0:
                      ...
                      Tlog.log(concat(_context9 = "\u538B\u7F29\u5931\u8D25\uFF01\n \u5F53\u524D\u6587\u4EF6\uFF1A".concat(imgPath, " \n ")).call(_context9, obj.message));
                      _context10.next = 10;
                      break;
        ...
        req.on("error", function (e) {
          ...
          Tlog.log(concat(_context11 = "\u8BF7\u6C42\u9519\u8BEF! \n \u5F53\u524D\u6587\u4EF6\uFF1A".concat(imgPath, " \n, ")).call(_context11, e));
        });
        req.end();
      })["catch"](function (error) {
        Tlog.log(error);
